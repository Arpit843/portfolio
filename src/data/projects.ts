...
export const projects: Project[] = [
...

  {
    ...
    status: 'completed',
    impact:
      'Early testers reported an average 18% reduction in tracked carbon footprint within 30 days using the weekly recommendation feature.',
    features: [
      'Daily habit logger with carbon-equivalent calculation per category',
      'Interactive footprint chart — weekly, monthly, yearly breakdown',
      'OpenMaps
